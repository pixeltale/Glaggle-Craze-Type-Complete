...
trigger1 = Vel Y > -1
trigger1 = Ctrl || StateNo = [600,710] && MoveContact || StateNo = [600,710] && Time <= 2
trigger2 = map(FlightControl) = 1
trigger2 = StateNo = 1200 && Vel Y > -1 && Var(7) && !MoveGuarded
trigger3 = StateNo = 1300 && AnimElemNo(0) = 5 && Anim = 1302
...
triggerall = (StateNo = [200,800) || StateNo = 900 || StateNo = 910 || StateNo = 930 || StateNo = [1000,1601]) && MoveHit || StateNo = 911 && (NumHelper(915) || MoveType = I) && MoveHit || StateNo = 912 && (NumHelper(920) || MoveType = I) && MoveHit
...
triggerall = StateNo != [800,900) && StateNo != [911,912] && !((StateNo = 1200 || StateNo = 1500) && Anim%2 && MoveGuarded) || StateNo = 911 && (NumHelper(915) || MoveType = I) && MoveGuarded || StateNo = 912 && (NumHelper(920) || MoveType = I) && MoveGuarded
...
triggerall = (ctrl || StateNo < 120) && !Var(51) || StateNo = 911 && (NumHelper(915) || MoveType = I) && !MoveContact || StateNo = 912 && (NumHelper(920) || MoveType = I) && !MoveContact
trigger1 = map(b_a) && map(b_y) && map(b_x) && map(b_b) && !Var(15)
trigger2 = Var(17) = 3000 && Var(15)
...
trigger2 = (Var(17) = 1100 || Var(17) = 1200 || Var(17) = 1300) && Var(15) && Random < 250
...
[State -1, 2QCF,b]
type = ChangeState
value = ifelse(StateType=A,2150,2101)
;triggerall = statetype != A
triggerall = Name != "GOLK"
triggerall = Power >= 1000
triggerall = ctrl || (StateNo = [100,101]) || (StateNo = [200,800) && StateNo != 510) && MoveContact || StateNo = [200,800) && Time <= 2
...
[State -1, 2QCF,a]
type = ChangeState
value = ifelse(StateType=A,2150,2100)
;triggerall = statetype != A
triggerall = Name != "GOLK"
triggerall = Power >= 1000
triggerall = ctrl || (StateNo = [100,101]) || (StateNo = [200,800) && StateNo != 510) && MoveContact || StateNo = [200,800) && Time <= 2
...
triggerall = ctrl || (StateNo = [100,101]) || (StateNo = [200,800) && StateNo != 510) && MoveContact || StateNo = [200,800) && Time <= 2
trigger1 = (map(b_y) && map(b_b) || map(b_yb)) && !Var(15)
trigger2 = (Var(17) = 900 || Var(17) = 1000 || Var(17) = 1200) && Var(15) && Random < 500

;---------------------------------------------------------------------------
; CTech Beetle Battery
[State -1, Y+B]
type = ChangeState
value = 900
triggerall = Name = "GOLI"
...
[State -1, ChUD,k]
type = ChangeState
value = 1351 + 199 * (Name="GOLK")
triggerall = statetype = A
triggerall = Vel Y > -1 || MoveContact
triggerall = ctrl || (StateNo = [100,101]) || (StateNo = [200,800) && StateNo != 510) && MoveContact || StateNo = [200,800) && Time <= 2
trigger1 = (map(b_a) || map(b_b)) && !Var(15)
trigger1 = Var(46) >= 24 && ((map(p_Dn)>0) || command = "down")
trigger2 = Var(17) = 1600 && Var(15) && Random < 250
trigger3 = map(b_ab) && (map(p_Dn)>0)

;---------------------------------------------------------------------------
; SP Volt Halberd
[State -1, ChDU,b]
type = ChangeState
value = 1301 + 200 * (Name="GOLK")
triggerall = statetype != A
...
trigger2 = Var(42) >= 24 && P2Dist X >= 0 && Facing = -1 && (((map(p_Fd)>0) && P2Dist X >= 0) || ((map(p_Bk)>0) && P2Dist X < 0))
trigger3 = Var(17) = 1200 && Var(15) && Random < 500
...
value = 610
triggerall = statetype = A
triggerall = ctrl && Map(FlightControl) != 1 || (StateNo = 600 || StateNo = 700) && MoveContact
trigger1 = map(b_y) && !Var(15)
trigger2 = Var(17) = 210 && Var(15) && Random < 500
