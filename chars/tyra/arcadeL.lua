...
for i = matchno(), 2 do
	if not launchFight{exclude = {"ajit", "ajit/ajik.def", "baxt/baxk.def", "baxt", "bern/berk.def", "bern", "boun/bouk.def", "boun", "cici", "cici/cick.def", "ikue/ikuk.def", "ikue", "isab", "isab/isak.def", "isab/isax.def", "jane/jank.def", "jane", "just/jusk.def", "just", "reap", "reap/reak.def", "teri", "teri/terk.def", "wall/walk.def", "wall", "sher", "sher/shek.def", "tsug", "tsug/tsuk.def", "goli", "goli/golk.def", "emic", "emic/emik.def", "necc", "necc/neck.def", "lucy", "lucy/luck.def", "gabb", "gabb/gabk.def", "tyra", "tyra/tyrx.def", "tyra/tyrk.def", "ajit/ajix.def", "gabb/gabx.def"}} then return end
end
